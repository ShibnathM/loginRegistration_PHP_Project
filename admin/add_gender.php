              ...
              <form role="form" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="product">Add Gender</label>
                      <input type="text" class="form-control" name="gender" id="product" placeholder="Enter Gender">
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['name']?>
                        <a href="delete_gender.php?id=<?php echo $row['id']?>" class="delete" title="delete" data-toggle="tooltip">
                          <i class="fa fa-times d-flex justify-content-end pr-1 text-danger" aria-hidden="true"></i>
                        </a>
                      </td>
                    </tr>
                  <?php
